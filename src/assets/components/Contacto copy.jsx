...
export default function Contacto() {
  return (
    <React.Fragment>
      ...
      <section className="py-6 bg-black" id="contacto">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap -mx-4">

            <div className="w-full px-4">
              <div className="flex xl:flex-row sm:flex-col max-w-lg mx-auto  pt-14 pb-16 ">
                ...
                <a href='https://maps.app.goo.gl/xWa8GaxC9hWeJRAB7' target="_blank" rel="web">
                  ...
                  <div className="w-full lg:w-1/2 px-4 order-last lg:order-first">
                    <img className="block max-w-lg mx-auto lg:max-w-none h-full w-full rounded-4xl object-cover" src="images/mapa.png" alt="">
                    </img>
                  </div>
